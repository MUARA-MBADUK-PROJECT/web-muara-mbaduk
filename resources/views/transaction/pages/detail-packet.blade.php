            ...
            <div id="container" class="flex flex-col gap-6">
                ...
                <article class="flex ">
                    <div class="w-24 shrink-0 h-24">
                        <img class="rounded-full  w-full h-full " src="{{$review['img']}}" alt="">
                    </div>
                    <div class="mt-4 ml-8">
                        <h3>{{$review['name']}}</h3>
                        <div class="flex">
                            @for($i = 0; $i < 5; $i++) <svg class="{{$i<=$review['star']? 'fill-yellow-300 stroke-yellow-300' : 'fill-none stroke-gray-600'}} " xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="F7AE40" stroke-width="0.5" stroke-linecap="sharp" stroke-linejoin="sharp" class="feather feather-star">
                        ...
                        <p class="text-text-black mt-4">{{$review['comment']}}</p>
                    </div>
                </article>
                @endforeach
            </div>
