...
<div id="explore" class="w-full bg-slate-50 p-[10%] flex flex-col md:flex-row  justify-center gap-20 ">
    <div class="flex-wrap w-full h-auto px-[5%]">
        ...
        <div class="mt-20 w-full">
            <img class="" src="{{asset('resources\images\eksplore-1.png')}}">
        </div>
    </div>
    <div class="flex-wrap h-auto w-full justify-item-end px-[5%] flex flex-col justify-end">
        ...
        <div class="mt-20 justify-center flex max-w-full">
